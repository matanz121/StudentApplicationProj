        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GradeSheetPath = table.Column<string>(type: "nvarchar(256)", nullable: true),
                    SyllabusPath = table.Column<string>(type: "nvarchar(256)", nullable: true),
                    CertificatePath = table.Column<string>(type: "nvarchar(256)", nullable: true)
                },
                constraints: table =>
                {
